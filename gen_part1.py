#!/usr/bin/env python3
"""Run this to write launch_build.py Part 1 (skeleton) to disk."""
import os
...
with open("launch_build.py", "w") as f:
    f.write("\n".join(LINES) + "\n")
print("launch_build.py written —", len(LINES), "lines. Ready for Part 1 impl.")
